...
import { LayoutDashboard, Plane, FolderOpen, Globe, FileText, MessageSquare, LogOut, Menu, X, Shield, Mail, Settings, Users, StarIcon } from "lucide-react";
...
const navItems = [
  ...
  { icon: StarIcon, label: "Reviews", path: "/admin/dashboard/reviews" },
