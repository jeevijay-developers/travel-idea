    ...
    <section className="relative min-h-[80vh] flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 py-20">
        <div className="max-w-2xl mx-auto text-center text-primary-foreground">
          ...
          {/* Subheadline */}
          <p className="text-lg sm:text-xl text-primary-foreground/90 mb-10 max-w-xl mx-auto animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-16 border-t border-primary-foreground/20 animate-fade-in max-w-2xl mx-auto" style={{ animationDelay: "0.5s" }}>
            {[
